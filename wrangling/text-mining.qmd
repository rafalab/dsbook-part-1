...
During the 2016 US presidential election, then candidate Donald J. Trump used his twitter account as a way to communicate with potential voters. On August 6, 2016, Todd Vaziri tweeted[^text-mining-1] about Trump that "Every non-hyperbolic tweet is from iPhone (his staff). Every hyperbolic tweet is from Android (from him)." David Robinson conducted an analysis[^text-mining-2] to determine if data supported this assertion. Here, we go through David's analysis to learn some of the basics of text mining. To learn more about text mining in R, we recommend the Text Mining with R book[^text-mining-3] by Julia Silge and David Robinson.

[^text-mining-1]: https://twitter.com/tvaziri/status/762005541388378112/photo/1

[^text-mining-2]: http://varianceexplained.org/r/trump-tweets/

[^text-mining-3]: https://www.tidytextmining.com/
...
It is not surprising that these are the top words, which are not informative. The *tidytext* package has a database of these commonly used words, referred to as *stop words*, in text mining:
...
This is just a simple example of the many analyses one can perform with tidytext. To learn more, we again recommend the Tidy Text Mining book[^text-mining-4].

[^text-mining-4]: https://www.tidytextmining.com/
