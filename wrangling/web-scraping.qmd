...
Let's say you want to retrieve COVID-19 deaths by state from the CDC. By visiting <https://data.cdc.gov> you can search for 
datasets and find that the data is provided through this API:
