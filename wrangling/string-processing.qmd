...
Finally, note that in this table we mention _groups_. These will be explained in Section @sec-groups.
...
Note that we can perform the above operation more efficiently with the function `recode`, which we learn about in Section @sec-recode.
