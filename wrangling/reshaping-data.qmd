...
4\. Loaded earlier, the `dslabs` package includes an `admissions` data set that contains admission information for men and women across six majors.  Create a `dat` object from it, omitting the applicants column:
