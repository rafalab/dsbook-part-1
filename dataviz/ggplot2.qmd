...
This is preferred as it makes it easier to read the text. In Section @sec-add-on-packages we learn a better way of assuring we can see the points and the labels.
