...
When you start a project you want to pick one directory to store all the files related to that project; and make that your working directory when running your analysis. If you provide a relative path to an importing function, it will search in the working directory. @sec-projects provides details on how to organize projects with RStudio.
