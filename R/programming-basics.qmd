...
## Conditional expressions {#sec-conditionals}
...
Now when we type `filter` it uses the __dplyr__ one. But what if we want to use the __stats__ version?
...
## Vectorization and functionals {#sec-vectorization}
