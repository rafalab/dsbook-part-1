...
<!--We have already described how we can access a terminal on a Mac (Section @sec-terminal-on-mac)) and Windows (Section \@ref(terminal-on-windows).-->
