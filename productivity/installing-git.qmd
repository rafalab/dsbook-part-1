...
In Chapter @sec-unix we will show how the terminal is our window into the Unix world. On a Mac you can access a terminal by opening the application in the Utilities folder:
